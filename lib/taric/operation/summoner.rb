...
module Taric
  module Operation
    module Summoner
      ...
      SUMMONER_BY_ACCOUNT = EndpointTemplate.new(template_url: "#{BASE_SUMMONER_URL}/by-account/{accountId}{?api_key}")
      ...
      def summoner_by_account_id(account_id:)
        response_for SUMMONER_BY_ACCOUNT, {accountId: account_id}
      end
